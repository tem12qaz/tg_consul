...
class Parser(object):
    ...
    def driver_do(cls, account_id, user_id, city_id, date, time):
        ...
        try:
            ...
            script = f'''var xhr = new XMLHttpRequest();xhr.open("POST", "https://ais.usvisa-info.com/en-ca/niv/schedule/{user_id}/appointment");xhr.send(JSON.stringify({data}));return [xhr.responseText, xhr.status];'''
